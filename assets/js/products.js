...
let cardInterior = joya =>
    ...
    ${(joya.Stock < 5) ? `<div class="flex flex-wrap w-4/5 justify-center mt-7 bg-red-500 transition duration-300 ease-in-out hover:scale-110 rounded-lg"><img class="w-[20px] h-[20px]" src="../assets/img/dobleright.png" alt=""><p class="h-[20px] cursor-pointer text-sm">¡¡ Ultimas unidades !!</p><img class="w-[20px] h-[20px]" src="../assets/img/dobleleft.png" alt=""><div>` : `<div class="h-[20px]"></div>`}
    </div>`;
